...
"open FZF in files mode in the root of ~/dev
nmap <leader>gw :Files! ~/dev<CR>
" Use FZF to change current directory to one of the git repos in ~/dev
nmap <leader>d :Cd ~/dev<CR>
